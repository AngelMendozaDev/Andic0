...
<style>
    body {
        background-image: url('Media/Pictures/fondo.jpg');
...
<div class="contenedor-formulario">
    ...
    <form action="Controllers/Registro.php" method="post" class="form-registra">
        <div class="for">
            ...
            <br><br> Si <input type="radio" id="si" name="check" value="si" required>
                      No <input type="radio" id="no" name="check" value="no" required> 
                     Tal vez <input type="radio" id="talvez" name="check" value="talvez" required>
            <br> <br>
